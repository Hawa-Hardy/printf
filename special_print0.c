...
/**
 * convert_fmt_p - Function prints the address of pointer
 * @args_list: Arguments list
 * @fmt_info: The format specifier info
 */
...
/**
 * convert_fmt_c - Function prints character
...
/**
 * convert_fmt_s - Prints string
 * @args_list: Arguments list
 * @fmt_info: Information of the format soecifier
 */
