...
/**
 * convert_fmt_di - Funtion outputs signed integer
 * @args_list: Arguments list
 * @fmt_info: Format specifier info
 *
...
/**
 * convert_fmt_xX - Function prints hexadecimal format of
 * an unsigned int
 * @args_list: Arguments list
 * @fmt_info: Format specifier info
 *
...
/**
 * convert_fmt_o - Prints octadecimal format of signed int
 * @args_list: ARguments list
 * @fmt_info: The format specifier info
 *
...
/**
 * convert_fmt_u - Function prints an unsigned integer
 * @args_list: Arguments list
 * @fmt_info: Format specifier info
 */
