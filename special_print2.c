...
/**
 * convert_fmt_b - Prints the base 2 format of an unsigned int argument
...
/**
 * convert_fmt_S - Prints out a string and the hex code for
...
/**
 * convert_fmt_r - Prints the string that has been reversed
 * @args_list: The arguments list
 * @fmt_info: The format info
 *
 * Return: The number of characters written
