...
/**
 * hex_digit - Changes a decimal < 16 to its hexadecimal form
 * @c: The decimal
 *
...
/**
 * str_to_int - Changes a string to an int
...
/**
 * bin_to_int - Changess an array of bits to an int
...
/**
 * long_to_oct - Changes a long integer to its octal representation
