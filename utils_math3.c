...
/**
 * round_float_to_int - Approximates a floating point number to an integer
 * @num: The floating point number to be approximated
...
/**
 * round_float - Approxiamtes a floating point number
 * @num: The floating point number to be approximated
