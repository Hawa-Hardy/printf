...
/**
 * u_long_to_str - Changes an unsigned long to its string representation
 * @num: The unsigned long integer
 *
 * Return: The string equivalent of the unsigned long integer
 */
...
/**
 * long_to_str - Changes a long to its string representation
 * @num: The long integer
 *
 * Return: The string equivalent of the long integer
 */
...
/**
 * ptr_to_str - Changes a pointer to its string representation
 * @ptr: The pointer
 *
...
/**
 * is_invalid - Confirms if a given float is invalid
 * @flt_info: The float info struct to be checked
 *
