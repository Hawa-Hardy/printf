...
/**
 * set_float_parts - Sets the float information fields to the appropriate
 * \ parts of a given float
 * @num: The given float
 * @exponent_size: The number of bits available in the exponent part
 * @mantissa_size: The number of bits available in the mantissa part
...
/**
 * mantissa_to_dec_fraction - Changes the mantissa of a float to a fraction
 * @mantissa: The mantissa to be changed
 * @frac_len: The maximum sizse of the decimal fraction
 *
